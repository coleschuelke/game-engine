...
int main(int argc, char** argv) {
  ...
  // Start Visualizer (Note, this change has not been tested on this autonomy
  // protocol yet)
  ...
  std::thread ap_thread_student([&]() {
    ...
    // Note this change was made on May 18th, 2023. Testing for this particular
    // autonmy protocol has not been done yet.
    while (first == true) {
