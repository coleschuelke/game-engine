...
// and is used to produce vectors containing samples of the trajectory generated
// by P4.
void ExampleAutonomyProtocol::BuildHistoryVectors(
    std::vector<double>& x_hist, std::vector<double>& y_hist,
    std::vector<double>& z_hist, const std::vector<double>& timestamps,
...
ExampleAutonomyProtocol::UpdateTrajectories() {
  ...
  while (bad_pos == true) {
    ...
    // Sampling Polynomial Trajectory
    {
      ...
      BuildHistoryVectors(vx_hist, vy_hist, vz_hist, times, path,
                          sampler_options);

      sampler_options.derivative_order = 2;
      std::vector<double> ax_hist, ay_hist, az_hist;
      BuildHistoryVectors(ax_hist, ay_hist, az_hist, times, path,
                          sampler_options);
